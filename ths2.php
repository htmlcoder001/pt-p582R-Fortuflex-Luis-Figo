  ...
  <body>
    <div class="left">
      <div class="header">
        ...
        <span>
		Em breve, o operador entrará em contato para confirmar o pedido.
        </span>
      </div>
        ...
        <div class="form-wrap">
          ...
          <form
            class="hidden-form" id="form" method="post"
             geo="pt" action="api.php"
	onsubmit="return validate_form(this, 'Digite o número de telefone correto');"
			>
